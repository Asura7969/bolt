package org.bolt.serializer

import java.io._
import java.nio.ByteBuffer

import org.bolt.RpcConf
import org.bolt.annotation.DeveloperApi
import org.bolt.util.{ByteBufferInputStream, ByteBufferOutputStream, Utils}
  ...
  class JavaSerializer(conf: RpcConf) extends Serializer with Externalizable {
    ...
    override def newInstance(): SerializerInstance = {
      ...
      val streamFactory: SerializationStreamFactory = classLoader
        .loadClass(conf.get("spark.rpc.serialization.stream.factory", "org.bolt.serializer.JavaSerializationStreamFactory"))
